...
SELECT token, created_at, updated_at, expires_at, revoked_at, user_id, expires_at > NOW() as expired_bool, revoked_at is null as revoke_check
FROM refresh_tokens
WHERE token = $1
`
